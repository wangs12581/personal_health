    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        ...
        <el-row style="margin: 0 20px;border-top: 1px solid rgb(245,245,245);">
            <el-table row-key="id" @selection-change="handleSelectionChange" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="detail" label="项目介绍"></el-table-column>
        ...
        <el-dialog :show-close="false" :visible.sync="dialogUserOperaion" width="26%">
            <div slot="title">
                <p class="dialog-title">{{ !isOperation ? '健康项目新增' : '健康项目修改' }}</p>
            </div>
    ...
    methods: {
        ...
        async fetchFreshData() {
            try {
                ...
                console.error('查询健康项目信息异常:', error);
            }
        },
        add() {
